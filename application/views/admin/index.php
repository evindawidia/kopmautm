...
<body id="page-top">
    ...
    <!-- Page level plugins -->
    <script src="<?php echo base_url() ?>public/asset/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="<?php echo base_url() ?>public/asset/js/demo/chart-area-demo.js"></script>
    <script src="<?php echo base_url() ?>public/asset/js/demo/chart-pie-demo.js"></script>
