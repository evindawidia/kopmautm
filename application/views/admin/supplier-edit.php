                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Edit Data Supplier</h1>
                        </div>
                        <form action="<?= base_url() . "Admin/doeditsupplier?id=" . $supplier->id_supplier ?>" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 mb-3 mb-sm-0">
                                    <input readonly type="text" class="form-control form-control-user" value="<?= $supplier->date_created ?>" placeholder="Date Created" name="date_created">
                                </div>
                            </div>
